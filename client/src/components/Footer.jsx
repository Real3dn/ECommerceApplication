      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              {/* Facebook Icon */}
              <a
                href="https://facebook.com/Real3dnShop"
                target="_blank"
              ...
              {/* Instagram Icon */}
              <a
                href="https://instagram.com/Real3dnShop"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-4">Get the latest updates on new products and upcoming deals</p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            {/* Social Links (alternative placement) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} Real3dn. All rights reserved.
            </p>
